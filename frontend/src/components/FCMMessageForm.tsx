            ...
            <TabsContent value="android" className="space-y-4 pt-4">
                <Card>
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2"><InfoTooltip contentKey="message.tooltips.android.priority"><Label>{t('message.android.config.priority')}</Label></InfoTooltip><Select value={formData.android?.priority} onValueChange={v => handleFormChange('android.priority', v === 'NONE' ? null : v)}><SelectTrigger><SelectValue placeholder="Select..." /></SelectTrigger><SelectContent><SelectItem value="NONE">{t('message.none')}</SelectItem><SelectItem value="NORMAL">NORMAL</SelectItem><SelectItem value="HIGH">HIGH</SelectItem></SelectContent></Select></div>
                ...
                <Card>
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2"><InfoTooltip contentKey="message.tooltips.android.notification.visibility"><Label>{t('message.android.notification.visibility')}</Label></InfoTooltip><Select value={formData.android?.notification?.visibility} onValueChange={v => handleFormChange('android.notification.visibility', v === 'NONE' ? null : v)}><SelectTrigger><SelectValue placeholder="Select..." /></SelectTrigger><SelectContent><SelectItem value="NONE">{t('message.none')}</SelectItem><SelectItem value="PRIVATE">PRIVATE</SelectItem><SelectItem value="PUBLIC">PUBLIC</SelectItem><SelectItem value="SECRET">SECRET</SelectItem></SelectContent></Select></div>
                        <div className="space-y-2"><InfoTooltip contentKey="message.tooltips.android.notification.notification_priority"><Label>{t('message.android.notification.priority')}</Label></InfoTooltip><Select value={formData.android?.notification?.notification_priority} onValueChange={v => handleFormChange('android.notification.notification_priority', v === 'NONE' ? null : v)}><SelectTrigger><SelectValue placeholder="Select..." /></SelectTrigger><SelectContent><SelectItem value="NONE">{t('message.none')}</SelectItem><SelectItem value="PRIORITY_MIN">MIN</SelectItem><SelectItem value="PRIORITY_LOW">LOW</SelectItem><SelectItem value="PRIORITY_DEFAULT">DEFAULT</SelectItem><SelectItem value="PRIORITY_HIGH">HIGH</SelectItem><SelectItem value="PRIORITY_MAX">MAX</SelectItem></SelectContent></Select></div>
                        <div className="space-y-2"><InfoTooltip contentKey="message.tooltips.android.notification.importance"><Label>{t('message.android.notification.importance')}</Label></InfoTooltip><Select value={formData.android?.notification?.importance} onValueChange={v => handleFormChange('android.notification.importance', v === 'NONE' ? null : v)}><SelectTrigger><SelectValue placeholder="Select..." /></SelectTrigger><SelectContent><SelectItem value="NONE">{t('message.none')}</SelectItem><SelectItem value="IMPORTANCE_MIN">MIN</SelectItem><SelectItem value="IMPORTANCE_LOW">LOW</SelectItem><SelectItem value="IMPORTANCE_DEFAULT">DEFAULT</SelectItem><SelectItem value="IMPORTANCE_HIGH">HIGH</SelectItem></SelectContent></Select></div>
                    </CardContent>
                </Card>
            </TabsContent>
